...
source_shaft_top_constraint = shaft_element.get_Parameter(BuiltInParameter.WALL_HEIGHT_TYPE).AsElementId()
source_shaft_top_offset = shaft_element.get_Parameter(BuiltInParameter.WALL_TOP_OFFSET).AsDouble()
...
with forms.WarningBar(title="Pick Shaft to match:", handle_esc=True):
    while True:
        ...
        with Transaction(doc,"Match Shafts") as t:
                ...
                target_shaft_element.get_Parameter(BuiltInParameter.WALL_HEIGHT_TYPE).Set(source_shaft_top_constraint)
                target_shaft_element.get_Parameter(BuiltInParameter.WALL_TOP_OFFSET).Set(source_shaft_top_offset)
