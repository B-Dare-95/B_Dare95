...
Last update:
- [04.05.2026] - 1.3.0 RELEASE
  - Category selection changed to single-select (RadioButton)
  - Added "Filter by Parameter Value" toggle with
    dual dropdowns (parameter / value)
- [01.05.2025] - 1.2.0 RELEASE
  - Updated UI to Catppuccin dark theme
- [19.02.2025] - 1.1.0 RELEASE
  - Added Negate Selection with SHIFT Click
